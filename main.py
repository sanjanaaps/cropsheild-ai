...
def main():
  ...
  data_dir = r'D:\PlantDoc-Dataset-master/train'
  custom_dataset = CustomDataset(data_dir, transform=transform, partition_index=None, num_partitions=1)
  ...
  test_dataset = CustomDataset(r'D:\PlantDoc-Dataset-master/test', transform=transform, partition_index=None, num_partitions=1)
